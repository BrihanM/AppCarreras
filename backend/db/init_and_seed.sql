...
INSERT INTO accounts (id, username, email, password_hash, photo, last_connection, created_at, updated_at) VALUES
  ('11111111-1111-4111-8111-111111111111', 'admin', 'admin@streeracex.test', 'pbkdf2:samplehash', 'https://example.com/avatars/admin.png', now() - interval '1 day', now(), now()),
  ('22222222-2222-4222-9222-222222222222', 'pilot_one', 'pilot1@streeracex.test', 'pbkdf2:samplehash', 'https://example.com/avatars/pilot1.png', now() - interval '2 days', now(), now()),
  ('33333333-3333-4333-a333-333333333333', 'pilot_two', 'pilot2@streeracex.test', 'pbkdf2:samplehash', 'https://example.com/avatars/pilot2.png', now() - interval '3 days', now(), now()),
  ('44444444-4444-4444-b444-444444444444', 'pilot_three', 'pilot3@streeracex.test', 'pbkdf2:samplehash', 'https://example.com/avatars/pilot3.png', now() - interval '4 days', now(), now()),
  ('55555555-5555-4555-8555-555555555555', 'pilot_four', 'pilot4@streeracex.test', 'pbkdf2:samplehash', 'https://example.com/avatars/pilot4.png', now() - interval '5 days', now(), now()),
  ('66666666-6666-4666-9666-666666666666', 'pilot_five', 'pilot5@streeracex.test', 'pbkdf2:samplehash', 'https://example.com/avatars/pilot5.png', now() - interval '6 days', now(), now())
